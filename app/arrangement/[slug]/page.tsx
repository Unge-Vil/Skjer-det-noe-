...
const SELECT =
  "id,title,title_en,description,description_en,address,accessibility,area,price,age_min,age_max,url,image_url,starts_at,ends_at,organizations!events_organization_id_fkey(name,slug),categories(slug),municipalities(name,kommunenummer),event_co_organizers(organizations(name,slug))";
